...
const AboutPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 scroll-smooth snap-y snap-mandatory overflow-y-scroll h-screen">
      ...
      {/* Footer */}
      <footer id="contact" className="relative py-12 snap-start bg-cover bg-center bg-no-repeat text-gray-300" style={{backgroundImage: `url('/lovable-uploads/dac9da36-69d5-4637-b181-e36b6aaf5d71.png')`, backgroundPosition: 'center 55%'}}>
